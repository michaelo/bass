...
// };
// window.appConfig expected set by /public/config.js as generated by entry.sh
const config = (window as any).appConfig as Config;
...
function setPipeline(name: string) {
    window.history.pushState(null, "", "?pipeline=" + name);
    title.value = name;
